...
We implement an LSTM baseline:
\begin{itemize}
    \item Input: Flattened density field
    \item Hidden dimension: 256
    \item Layers: 2
    \item Output: Next density field
\end{itemize}

\subsection{Convolutional Neural Networks}

A U-Net style architecture:
\begin{itemize}
    \item Encoder: 4 convolutional blocks with downsampling
    \item Decoder: 4 transposed convolutional blocks
...
\begin{itemize}
    ...
    \item \textbf{Training infrastructure:} PyTorch Lightning
    \item \textbf{Experiment tracking:} Weights \& Biases
\end{itemize}
...
Confidence intervals are computed over 5 independent training runs.
